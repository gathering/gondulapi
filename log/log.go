/*
 * svipul^Wgondulapi log-wrappers
 *
 * Copyright (c) 2022-2024 Telenor Norge AS
 * Author(s):
...
we've turned on debugging. This makes calls to Debug() very fast
...
// Verbose enables verbose logging, including filenames/line numbers in log
// entries and printing Debug/Debugf() logs too.
var Verbose = true
